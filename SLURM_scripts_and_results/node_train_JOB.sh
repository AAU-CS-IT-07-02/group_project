...
#SBATCH --output=/nfs/home/student.aau.dk/cj32if/group_project/SLURM_scripts_and_results/node_train-OUTPUT/node_train-JOB-%j.out  # Redirect the output stream to this file (%j is the jobid)
#SBATCH --error=/nfs/home/student.aau.dk/cj32if/group_project/SLURM_scripts_and_results/node_train-OUTPUT/node_train-JOB-%j.err   # Redirect the error stream to this file (%j is the jobid)
